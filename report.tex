...
\begin{itemize}[label={}]
    \item {\color{blue} \emph{\href{https://www.facebook.com/pythonsul/}{Python Sul}}}:
    Página oficial do evento voltado para as a comunidade Python na região do Brasil
    \item {\color{blue} \emph{\href{https://www.facebook.com/groups/python.floripa/}{Python Floripa}}}:
    Grupo voltado para pessoas da comunidade Python na cidade de Florianópolis
    \item {\color{blue} \emph{\href{https://www.facebook.com/PyTche/}{PyTchê}}}:
    Grupo de usuários Python do Rio Grande do Sul
\end{itemize}
